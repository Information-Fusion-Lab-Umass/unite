...
for i in range(T):
  ...
  results[0].append(ests.unite_estimator_fast(n, p, y, mugraph, z, beta))
  results[1].append(ests.unite_estimator_wis_fast(n, p, y, mugraph, z, beta))



print ("UNITE", np.mean(np.array(results[0])/TTE))
print ("UNITE-WIS", np.mean(np.array(results[1])/TTE))
